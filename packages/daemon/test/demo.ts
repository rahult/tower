	...
	if (spec.sessionId.includes("research-brief"))
		return [
			questionTurn("Research brief", [
				...
				"## Sources",
				"",
				"- <https://martinfowler.com/eaaDev/EventSourcing.html> — the event-log pattern, applied to state.",
				"- <https://inkandswitch.com/local-first/> — local-first software, where the merge conflicts come from.",
				"",
				"## Recommendation",
				"",
