...
describe("renderPrompt", () => {
	...
	it("renders the shipped planning prompt with no holes", () => {
		const out = renderPrompt(
			...
			{ "stage-result-contract": readFileSync(join(prompts, "partials", "stage-result-contract.md"), "utf8"), "invariant-protocol": "", "parallel-work": "", research: "", "system-model": "", acceptance: "" },
		);
