...
export const button = {
	...
	onCaution: "cursor-pointer rounded-md bg-caution px-3 py-1.5 text-[14px] font-semibold text-caution-ink hover:brightness-105 disabled:cursor-default disabled:opacity-45",
